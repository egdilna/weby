<meta lang="cz" charset="utf-8" emacsmode="-*- markdown -*-"><link rel="stylesheet" href="https://casual-effects.com/markdeep/latest/website.css?"><style class="fallback">body{visibility:hidden}</style><script>markdeepOptions={tocStyle:'long', autoLinkImages: false, definitionStyle: 'short'};</script><!-- Markdeep: --><script src="https://casual-effects.com/markdeep/latest/markdeep.min.js?" charset="utf-8"></script>

# Základní minimum pro...

Co určitě vědět? Níže jsou po jednotlivých skupinách rozebrány ty nejzákladnější věci a samozřejmě je tam i spousta odkazů na další zdroje. Tohle tedy berte jako takové první místo vašich znalostí.
...
- Legislativa: [dokument Podrobný popis vybraných EG předpisů](http://www.openczeg.cz//otevrene-metodiky/legislativa/eg-legislativa-podrobny-popis/), [předpis Informační koncepce ČR](https://archi.gov.cz/ikcr)
- Konkrétní EG: [Web Národní architektury EG](https://archi.gov.cz), [nástroj Mapa EG povinností](http://www.egdilna.cz/mapapovinnosti), [předpis Národní architektonický plán](https://archi.gov.cz/nap_dokument)
- Kde se učit?

- Pro úřady jsou zajímavé učební texty [stránka Pyramida všeho důležitého v EG - EGOVedu učební texty](https://github.com/egdilna/egovedu/blob/main/ucebni-texty/pyramida-vseho-duleziteho.markdeep.md), [stránka Interakce mezi veřejnou správou a klientem, služby a úkony, práva a povinnosti - EGOVedu učební texty](https://github.com/egdilna/egovedu/blob/main/ucebni-texty/interakce-ukon-sluzba-klient.markdeep.md), [stránka Strategický rámec pro rozvoj IT v organizaci - EGOVedu učební texty](https://github.com/egdilna/egovedu/blob/main/ucebni-texty/strategie-v-organizaci.markdeep.md, [dokument Jak správně pracovat s Národním architektonickým plánem](http://www.openczeg.cz//otevrene-metodiky/architektura/jak-na-nacr/NAP-jak-s-nim-pracovat/)), [Poznáváme jazyk ArchiMate česky](http://www.openczeg.cz//otevrene-metodiky/architektura/poznavame-archimate/)
- Pro úřady jsou zajímavé z archi.gov.cz třeba [Základní registry z NAP](https://archi.gov.cz/nap:zakladni_registry), [Agendový model veřejné správy z NAP](https://archi.gov.cz/nap:agendovy_model_verejne_spravy), [Globální architektura propojeného datového fondu](https://archi.gov.cz/znalostni_baze:ga_ppdf), [Klíčové oblasti architektury eGovernmentu](https://archi.gov.cz/uvod_klicove_oblasti), [Popis sdílených služeb, funkčních celků a tematických oblastí veřejné správy ČR Architektura eGovernmentu ČR]](https://archi.gov.cz/nap_dokument:architektura_a_sdilene_sluzby_verejne_spravy_cr), [Registr práv a povinností z NAP](https://archi.gov.cz/nap:rpp), [Sdílení údajů veřejné správy z NAP](https://archi.gov.cz/nap:sdileni_udaju)
